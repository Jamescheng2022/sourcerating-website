...
export const metadata: Metadata = {
  ...
  keywords: [
    "engineering supplier verification Asia",
    "construction materials sourcing China",
    "Vietnam supplier verification",
    "steel structure factory audit",
    "PEB sourcing Asia",
    "prefab supplier verification",
    "construction materials inspection Asia",
    "engineering procurement advisor",
  ],
